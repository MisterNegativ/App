      ...
      <ScrollView contentContainerStyle={styles.scrollContent} style={styles.container}>
        <Card style={styles.card}>
          <Card.Content>
            ...
            <List.Section>
              <List.Accordion
                title={selectedEmployee ? `${selectedEmployee.firstName} ${selectedEmployee.lastName}` : 'Выберите сотрудника'}
                left={props => <Avatar.Icon {...props} icon="account" color={theme.colors.background} />}
              ...
              >
                {employees.map(emp => (
                  <List.Item
                    ...
                    onPress={() => { setSelectedEmployee(emp); setShowEmployeeList(false); }}
                    titleStyle={{ color: theme.colors.text }}
                  />
                ))}
              </List.Accordion>
            </List.Section>
            <Button icon="calendar" mode="contained" onPress={showDatePicker} style={styles.button}>
